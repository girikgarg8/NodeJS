...
async function process1() {
    ...
    return " process1 async completed" //this is equivelent to saying Promise.resolve("process1 async completed")
}
async function process2() {
    ...
    return " process2 async completed" //this is equivelent to saying Promise.resolve("process2 async completed")
}
...
//DRY RUN AND PREDICT THE OUTPUT: TODO